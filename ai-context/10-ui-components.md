...
- When `taxScenarioResult` is present, shows recommended filing/dividend combination, regular tax, AMT supplement, and payable tax. 「了解更多」 opens all scenario formulas and highlights the lowest result.
