...
| [`tests/paymentOffers.test.ts`](../tests/paymentOffers.test.ts) | Payment reward loader/solver contracts, card filtering, reward-unit calculations, and `eligibility_restrictions` coverage for new-customer and special-member exclusion filters; fixtures read [`public/data/tax_payment_rewards_114.json`](../public/data/tax_payment_rewards_114.json) (same as [`rewardUnits.test.ts`](../tests/rewardUnits.test.ts)) |
